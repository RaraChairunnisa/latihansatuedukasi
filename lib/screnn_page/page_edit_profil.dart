...
import 'package:latihansatuedukasi/model/model_profile.dart';
import 'package:latihansatuedukasi/utils/session_manager.dart';
  ...
  Future<ModelProfile?> updateAccount() async {
    ...
    try {
      ...
      http.Response response = await http.post(
          Uri.parse('http://172.20.10.7/edukasi_server2/updateUser.php'),
          body: {
